                ...
                <div className="mb-6">
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full">
                      <thead className="bg-gray-50">
                        <tr>
                          <th className="px-4 py-2 text-left text-xs font-medium text-gray-500">İşlem Tipi</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.walletTransactions.volume - receipt.walletTransactions.commission)}
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td className="px-4 py-2 whitespace-nowrap">
                            <span className="text-sm font-medium">İade</span>
                          </td>
                          <td className="px-4 py-2 whitespace-nowrap">
                            <button 
                          ...
                          <td className="px-4 py-2 whitespace-nowrap font-medium text-red-600">
                            -{formatCurrency(totalWalletRefunds)}
                          </td>
                        </tr>
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.walletTransactions.volume - totalWalletRefunds)}
                          </td>
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.walletTransactions.commission)}
                          </td>
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(displayNetWalletAmount)}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table className="min-w-full">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.creditTransactions.volume - receipt.creditTransactions.commission)}
                          </td>
                        </tr>
                        ...
                        <tr className="bg-gray-50">
                          ...
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.creditTransactions.volume - creditRefunds)}
                          </td>
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(receipt.creditTransactions.commission)}
                          </td>
                          <td className="px-4 py-2 whitespace-nowrap font-medium">
                            {formatCurrency(displayCreditNetAmount)}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="border-t border-gray-200 pt-4 mt-2">
                      <div className="flex justify-between items-center text-lg">
                        <span className="font-semibold">Net Ödeme Tutarı:</span>
